...
##### The column for the in-sample PGS based on PRScsauto is named according to the format 'PRSprscsauto_${TRAIT}' in this file
...
#### Outputs
IMPUTED_OUTPUT="../ukbb200k_PGSadjust_results_${TRAIT}_PRSprscsauto_insample_bgenoutput"
GT_OUTPUT="../ukbb200k_PGSadjust_results_${TRAIT}_PRSprscsauto_insample_statsoutput"
