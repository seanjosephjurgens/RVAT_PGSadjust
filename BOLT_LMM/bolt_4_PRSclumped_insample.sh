...
# Import phenotype and covar file for QCd samples from the initial 200k freeze of UKB, which includes the in-sample derived PGS for all traits
##### The column for the in-sample PGS based on lead-SNPs is named according to the format 'PRSclumped_${TRAIT}' in this file
dx download ${PROJECT}:path/to/phenofile/phenofile_wes_total_quantitative_forBOLT_insample.txt

#### Inputs
PLINK_FILE=ukbb200k_array_chrall
PHENO_FILENAME=phenofile_wes_total_quantitative_forBOLT_insample.txt
...
#### Outputs
IMPUTED_OUTPUT="../ukbb200k_PGSadjust_results_${TRAIT}_PRSclumped_insample_bgenoutput"
GT_OUTPUT="../ukbb200k_PGSadjust_results_${TRAIT}_PRSclumped_insample_statsoutput"
...
# When using Swiss Army Knife files will be automatically uploaded to the destination directory
