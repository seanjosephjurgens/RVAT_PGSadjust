...
./regenie_v3.2.2.gz_x86_64_Linux_mkl \
    ...
    --covarColList PRSprscsauto_${TRAIT},sequencing_batch,genotyping_array,Inferred_Gender,enroll_age,enroll_age2,PC1,PC2,PC3,PC4,PC5,PC6,PC7,PC8,PC9,PC10,PC11,PC12,PC13,PC14,PC15,PC16,PC17,PC18,PC19,PC20 \
    --catCovarList PRSprscsauto_${TRAIT},sequencing_batch,genotyping_array,Inferred_Gender \
...
./regenie_v3.1.3.gz_x86_64_Linux_mkl \
    ...
    --print-pheno \
    --bsize 200 \
    --out ../REGENIE_STEP2_${TRAIT}_PRScsauto_insample_chr${chr}
done
